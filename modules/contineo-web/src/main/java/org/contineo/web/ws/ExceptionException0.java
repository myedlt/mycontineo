...
public class ExceptionException0 extends java.lang.Exception {
    ...
    private org.contineo.web.ws.DmsStub.Exception0 faultMessage;
    ...
    public void setFaultMessage(org.contineo.web.ws.DmsStub.Exception0 msg) {
        faultMessage = msg;
    }

    public org.contineo.web.ws.DmsStub.Exception0 getFaultMessage() {
        return faultMessage;
    }
}
