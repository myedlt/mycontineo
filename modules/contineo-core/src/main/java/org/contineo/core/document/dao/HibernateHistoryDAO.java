...
public class HibernateHistoryDAO extends HibernateDaoSupport implements HistoryDAO {
	...
	/**
	 * @see org.contineo.core.document.dao.HistoryDAO#store(org.contineo.core.document.History)
	 */
	...
	/**
	 * @see org.contineo.core.document.dao.HistoryDAO#delete(int)
	 */
	...
	/**
	 * @see org.contineo.core.document.dao.HistoryDAO#findByDocId(int)
	 */
	...
	/**
	 * @see org.contineo.core.document.dao.HistoryDAO#findByUsername(java.lang.String)
	 */
	@SuppressWarnings("unchecked")
