...
public class HibernateUserDAO extends HibernateDaoSupport implements UserDAO {
	...
	/**
	 * @see org.contineo.core.security.dao.UserDAO#delete(java.lang.String)
	 */
	...
	/**
	 * @see org.contineo.core.security.dao.UserDAO#existsUser(java.lang.String)
	 */
	...
	/**
	 * @see org.contineo.core.security.dao.UserDAO#findAll()
	 */
	...
	public Collection<User> findAll() {
		...
		try {
			coll = (Collection<User>) getHibernateTemplate().find("from org.contineo.core.security.User");
		} catch (Exception e) {
			if (log.isErrorEnabled())
				log.error(e.getMessage(), e);
		}
	...
	/**
	 * @see org.contineo.core.security.dao.UserDAO#findByName(java.lang.String)
	 */
	@SuppressWarnings("unchecked")
	public Collection findByName(String name) {
		...
		try {
			coll = (Collection<User>) getHibernateTemplate().find(
					"from org.contineo.core.security.User _user where _user.name like ?", new Object[] { name });
		} catch (Exception e) {
			if (log.isErrorEnabled())
				log.error(e.getMessage(), e);
		}
	...
	/**
	 * @see org.contineo.core.security.dao.UserDAO#findByPrimaryKey(java.lang.String)
	 */
	...
	/**
	 * @see org.contineo.core.security.dao.UserDAO#findByUserName(java.lang.String)
	 */
	@SuppressWarnings("unchecked")
	public Collection<User> findByUserName(String username) {
		...
		try {
			coll = (Collection<User>) getHibernateTemplate().find(
					"from org.contineo.core.security.User _user where _user.userName like ?", new Object[] { username });
	...
	/**
	 * @see org.contineo.core.security.dao.UserDAO#findByUserNameAndName(java.lang.String,
	 *      java.lang.String)
	 */
	@SuppressWarnings("unchecked")
	public Collection<User> findByUserNameAndName(String username, String name) {
		...
		try {
			coll = (Collection<User>) getHibernateTemplate().find(
					"from org.contineo.core.security.User _user where _user.name like ? and _user.userName like ?",
	...
	/**
	 * @see org.contineo.core.security.dao.UserDAO#store(org.contineo.core.security.User)
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * @see org.contineo.core.security.dao.UserDAO#validateUser(java.lang.String,
	 *      java.lang.String)
	 */
