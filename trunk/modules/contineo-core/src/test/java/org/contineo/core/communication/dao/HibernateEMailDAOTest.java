...
public class HibernateEMailDAOTest extends AbstractCoreTestCase {
    ...
    public void testStore() {
        ...
        message.setSubject("[Contineo-devel] Join Contineo developer community");
        ...
        message.setFolder("Contineo-devel");
        ...
        recipient2.setAddress("author@contineo.sf.net");
        recipient2.setName("Contineo Author");
