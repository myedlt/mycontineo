...
INSERT INTO co_account values(1,'admin','author@contineo.sf.net','Aruba','pcalle','port','author@contineo.sf.net','authorPSWD',1,'pdf,doc','it',1,1);
INSERT INTO co_account values(2,'author','admin@contineo.sf.net','Aruba','pcalle','port','admin@contineo.sf.net','adminPSWD',2,'doc,txt','en',0,1);
