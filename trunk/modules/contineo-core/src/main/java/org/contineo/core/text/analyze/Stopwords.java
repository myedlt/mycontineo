...
public class Stopwords {
	...
	private final static String[] ROMANIAN_STOP_WORDS = { "o", "unui", "unei", "unor", "nişte", "cel", "cea", "cei",
			"cele", "celui", "celei", "celor", "al", "a", "ai", "ale", "pe", "la", "în ", "fără", "sub", "despre",
			"către", "cu", "de", "din ", "lângă", "pentru", "peste", "spre", "prin", "dintre", "printre", "până",
			"după", "înspre", "ca", "mai", "decât", "cum", "foarte", "mult", "multă", "mulţi", "multe", "puţin",
			"puţină", "puţini", "puţine", "destul", "destulă", "destui", "destule", "eu", "tu", "el", "ea", "noi",
			"voi", "ei", "ele", "mie", "îmi", "mi", "mine", "mă", "m", "ţie", "îţi", "ţi", "tine", "te", "lui", "îl",
			"l", "îi", "i", "nouă", "ne", "ni", "vouă", "vă", "vi", "v", "lor", "le", "li", "dumneavoastră", "se",
			"îşi", "sie", "sieşi", "sine ", "însumi", "însămi", "însuţi", "însăţi", "însuşi", "însăşi", "înşine",
			"însene", "înşivă", "însevă", "înşişi", "înseşi", "însele", "meu", "mea", "mei", "mele", "tău", "ta",
			"tăi", "tale", "său", "sa", "săi", "sale", "nostru", "noastră", "noştri", "noastre", "vostru", "voastră ",
			"voştri", "voastre", "acesta", "ăsta", "aceştia", "ăştia", "acestuia", "ăstuia", "acestora", "ăstora",
			"aceasta", "asta", "acestea", "astea", "acesteia", "ăsteia", "acest", "aceşti", "acestui", "acestor",
			"această", "aceste", "acestei", "acela", "ăla", "acelui", "ăluia", "aceia", "ăia", "acelora", "ălora",
			"aceea", "aia", "acelea", "alea", "aceleia", "ăleia", "acel", "acei", "acelor", "acea", "acele", "acelei",
			"acelaşi", "aceiaşi", "aceeaşi", "aceleaşi", "aceluiaşi", "aceloraşi", "aceleiaşi", "celălalt",
			"celuilalt", "ceilalţi", "celorlalţi", "cealaltă", "celeilalte", "celelalte", "celorlalte", "ce", "cine",
			"cui", "care", "cărui", "cărei", "căror ", "unde", "când", "cineva", "cuiva ", "altcineva", "altcuiva ",
			"oricine", "oricui", "orice", "unul", "una", "unii", "unele", "unuia", "uneia", "unora ", "altul", "alta",
			"alţii", "altele", "alt", "altă", "alţi", "alte", "altuia", "alteia", "altora", "altui", "altei", "altor",
			"vreunul", "vreuna", "vreunii", "vreunele", "vreun", "vreo", "vreunuia", "vreuneia", "vreunora", "vreunui",
			"vreunei", "vreunor", "oricare", "oricăruia", "oricăreia", "oricărora", "oricărui", "oricărei", "oricăror",
			"fiecare", "fiecăruia", "fiecăreia", "fiecărui", "fiecărei", "cât", "câtă", "câţi", "câte", "câtora",
			"câtor", "atât", "atâta", "atâţi", "atâţia", "atâtea", "atâtora", "atâtor", "oricât", "oricâtă", "oricâţi",
			"oricâte", "oricâtora", "oricâtor", "câtva", "câţiva", "câteva", "câtorva", "tot", "toată", "toţi",
			"toate", "tuturor", "totul", "cutare", "oarecare", "ceva", "altceva", "nimeni", "nimănui", "nimic", "unu",
			"doi", "doua", "trei", "patru", "cinci", "şase", "şapte", "opt", "noua", "zece", "doime", "treime",
			"sutime", "amândoi", "amândouă", "amândurora", "amânduror", "ambii", "ambele", "ambilor", "ambelor",
			"îndoit", "întreit", "însutit", "întâiul", "întâia", "primul", "prima", "primii", "primele", "primului",
			"primei", "primilor", "primelor", "sunt", "s", "eşti", "este", "e", "suntem", "sunteţi", "eram", "erai ",
			"era", "eraţi", "erau", "fiu", "fii", "fie", "fim", "fiţi", "fi", "fiind", "fost", "am", "aţi", "au",
			"are", "avem", "aveţi", "aveam", "aveai", "avea", "aveaţi", "aveau", "aş", "ar", "oi", "om", "oţi", "or",
			"vei", "va", "vom", "veţi", "vor", "şi", "nici", "dar", "însă", "iar", "ci", "sau", "ori", "deci",
			"aşadar", "încât", "aşa", "deşi ", "totuşi", "dacă", "atunci", "că", "nu", "poate", "ieri", "mare",
			"doar ", "trebuie", "spus", "acum", "putea", "chiar", "face", "astfel", "pot", "făcut", "avut", "parte",
			"spune", "bine", "faţă", "există", "încă", "numai", "dat", "asupra", "aproape" };
    ...
    static {        
    	...
    	stopwordsMap.put("ro", ROMANIAN_STOP_WORDS);
    }
