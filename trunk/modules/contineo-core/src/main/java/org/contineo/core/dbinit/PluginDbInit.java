package org.contineo.core.dbinit;
...
import org.contineo.util.PluginRegistry;
import org.contineo.util.dbinit.DBInit;
...
public class PluginDbInit extends DBInit {
	...
	public void init() {
		...
		Collection<Extension> exts = registry.getExtensions("contineo-core", "DbInit");
		...
		getSqlList().clear();
		getSqlList().add("org/contineo/core/contineo-core.sql");
