...
public abstract class DmsCallbackHandler {
    ...
    public void receiveResultcheckin(
        org.contineo.web.ws.DmsStub.CheckinResponse result) {
    }
    ...
    public void receiveResultcreateDocument(
        org.contineo.web.ws.DmsStub.CreateDocumentResponse result) {
    }
    ...
    public void receiveResultsearch(
        org.contineo.web.ws.DmsStub.SearchResponse result) {
    }
    ...
    public void receiveResultdownloadDocumentInfo(
        org.contineo.web.ws.DmsStub.DownloadDocumentInfoResponse result) {
    }
    ...
    public void receiveResultdeleteFolder(
        org.contineo.web.ws.DmsStub.DeleteFolderResponse result) {
    }
    ...
    public void receiveResultdownloadDocument(
        org.contineo.web.ws.DmsStub.DownloadDocumentResponse result) {
    }
    ...
    public void receiveResultdeleteDocument(
        org.contineo.web.ws.DmsStub.DeleteDocumentResponse result) {
    }
    ...
    public void receiveResultcreateFolder(
        org.contineo.web.ws.DmsStub.CreateFolderResponse result) {
    }
    ...
    public void receiveResultcheckout(
        org.contineo.web.ws.DmsStub.CheckoutResponse result) {
    }
    ...
    public void receiveResultdownloadFolderContent(
        org.contineo.web.ws.DmsStub.DownloadFolderContentResponse result) {
    }
