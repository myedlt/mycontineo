...
public class AccountsRecordsManager {
	...
	public String edit() {
		...
		AccountForm accountForm = ((AccountForm) FacesContext.getCurrentInstance().getApplication().createValueBinding(
				"#{accountForm}").getValue(FacesContext.getCurrentInstance()));
